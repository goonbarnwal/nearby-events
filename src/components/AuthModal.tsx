          ...
          {showGooglePicker ? (
            <div className="space-y-4 animate-in zoom-in-95 duration-200">
              ...
              {savedUser && (
                <div className="space-y-1">
                  <div className="flex items-center justify-between px-1">
                    <span className="text-[10px] font-bold text-slate-400 uppercase tracking-wider">Saved Google Account</span>
                    <button
                      type="button"
                      onClick={() => {
              ...
              <div className="border-t border-slate-100 dark:border-slate-800 pt-3">
                <p className="text-[11px] font-bold text-slate-500 dark:text-slate-400 mb-2">Use custom Google profile:</p>
                <form
                  onSubmit={(e) => {
                    e.preventDefault();
                ...
                >
                  <input
                    type="text"
                    placeholder="Full Name (e.g. Goon Barnwal)"
                  ...
                  <input
                    type="email"
                    placeholder="Google Email (e.g. barnwalgoon@gmail.com)"
